#A Meteor wrapper around Fuse.js

This package is a Meteor wrapper around [fuse](https://github.com/krisk/Fuse) by [Krollos Risk](https://github.com/krisk)

##Installing
```javascript
meteor add art1sec8:fuse
```
